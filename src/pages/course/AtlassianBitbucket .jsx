            ...
            <div className='flex flex-col-reverse lg:flex-row mx-auto mt-32 w-11/12 lg:w-4/5 p-4 gap-12'>
                <div className='w-full lg:w-2/3'>
                    <div className='flex flex-wrap gap-20 mt-16'>
                        <div className='flex flex-col items-center gap-2'>
                            <h1 className='text-2xl lg:text-3xl'>1H 20M</h1>
                    ...
                    <div className="bg-black text-white p-4 mt-20">
                        ...
                        >
                            <div className='flex justify-between items-center mt-4 mb-4'>
                                <p className="text-lg">Atlassian Bitbucket Vulnerability Exploitation and Mitigation</p>
                                {/* Arrow */}
                                <span
                            ...
                            >
                                <li className="pl-4 mb-4 flex text-gray-400 justify-between"><span>Introduction to Atlassion Bitbucket</span> <span>10M</span></li>
                    ...
                    <div className='p-4 mt-12'>
                        ...
                        <div className='mt-6'>
                            <h2 className='text-3xl'>What makes this course unique?</h2>
                            <p className='text-gray-400 mt-4'>
                            By the end of this course, you should be able to:
                            </p>
                            <ul className='text-gray-400 mt-2'>
                                <li className='flex gap-4'><TbPointFilled className='text-white mt-1' /> Define the vulnerability, describe its root cause, and communicate its significance to key organizational stakeholders.</li>
                ...
                <div className='w-full lg:w-1/3'>
                    ...
                    <div className='mt-12'>
                        ...
                        <p className='text-center text-gray-400 mt-8'>Complete this entire course to earn a CVE Series: Atlassian Bitbucket Command Injection (CVE-2022-36804) Certificate of Completion</p>
                    </div>
                </div>
            </div>
        </div>
