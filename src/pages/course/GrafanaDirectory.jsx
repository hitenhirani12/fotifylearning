                    ...
                    <div className="bg-black text-white p-4 mt-20">
                        ...
                        >
                            <div className='flex justify-between items-center mt-4 mb-4'>
                                <p className="text-lg">Exploit and Mitigate the Grafana Directory Traversal Vulnerability</p>
                                {/* Arrow */}
                                <span
                            ...
                            >
                                <li className="pl-4 mb-4 flex text-gray-400 justify-between"><span>CVE Exploitation</span> <span>30M</span></li>
...
export default GrafanaDirectory;